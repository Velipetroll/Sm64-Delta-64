smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("Welcome to Mario Land,\
if you're ready for a\
superstar adventure,\
you're in the right\
place!"))

smlua_text_utils_dialog_replace(DIALOG_001,1,4,95,200, ("Every level of this game \
has 2 stars, one that \
has 6 secrets around it, \
and one that is usually \
a boss."))

smlua_text_utils_dialog_replace(DIALOG_002,1,4,30,200, ("If you're reading this\
and needs to get down\
there, jump off from\
the direction of this\
sign.\
\
Don't be scared, as long\
as you aim yourself\
to the water you're\
gonna be fine."))

smlua_text_utils_dialog_replace(DIALOG_003,1,6,30,200, ("Maybe there's something\
hidden under one of\
those thwomps."))

smlua_text_utils_dialog_replace(DIALOG_004,1,4,30,200, ("Maybe if you come back\
with a star, someone \
might show up!"))

smlua_text_utils_dialog_replace(DIALOG_005,1,6,30,200, ("     -- WARNING --\
Moving sand is extremely\
dangerous! Avoid touching\
it at all cost!"))

smlua_text_utils_dialog_replace(DIALOG_006,1,2,30,200, ("-- DO NOT ENTER. --\
POINT OF NO RETURN."))

smlua_text_utils_dialog_replace(DIALOG_007,1,6,30,200, ("-- CONSTRUCTION --\
\
Koopa Library.\
Please walk quietly.\
Sit in not available.\
\
Please take out a book,\
log it, and read it\
elsewhere. All minions\
must return books\
three weeks after\
sign out. Thanks!"))

smlua_text_utils_dialog_replace(DIALOG_008,1,6,30,200, ("-- WARNING --\
\
This specific cap switch\
will activate all switches\
and more.\
\
Do NOT activate this\
switch under any\
circumstances,\
as it will help Mario\
and then some.\
Step away now."))

smlua_text_utils_dialog_replace(DIALOG_009,1,6,30,200, ("-- WARNING --\
\
Okay, seriously.\
If you think we didn't\
mean the last warnings,\
you're right.\
Bowser's Room is right\
up ahead. We mean it\
when we say you'll be\
sorry when you enter.\
Don't say we didn't\
warn ya!"))
...
smlua_text_utils_dialog_replace(DIALOG_012,1,4,30,200, ("Alert!!\
\
All cap switches are\
now active.\
\
Would you like to Save?\
\
...
smlua_text_utils_dialog_replace(DIALOG_017,1,4,30,200, ("What is a plumber doing\
here and why did you\
take my coins?\
Leave or i'll have to\
make you."))

smlua_text_utils_dialog_replace(DIALOG_018,1,4,30,200, ("       ~Credits~\
Mario Delta 64 made\
by NicoSwitch.\
\
Models, Music, Skyboxes,\
Hud Textures by \
NicoSwitch. (Which \
includes original \
compositions by me \
for the main levels.)\
\
Thank you Blakeoramo\
for helping me with a lot\
of how the stuff works\
because im stupid.\
\
Thank you Troopsushi\
for making the goomba\
texture for this.\
\
Thank you MarioNova\
for giving me permission\
to use the Mario model.\
\
Thank you SpookyGuga\
for beta testing.\
\
And thank you for\
getting this game!\
...
smlua_text_utils_dialog_replace(DIALOG_019,1,6,30,200, ("If you wish to leave\
the garden go into\
this pipe.\
\
But if you dont..I heard\
...
smlua_text_utils_dialog_replace(DIALOG_022,1,2,95,200, ("A strange force blocks\
the door. It cannot open."))
...
smlua_text_utils_dialog_replace(DIALOG_046,1,5,30,200, ("     -- WARNING --\
Moving sand is extremely\
dangerous! Avoid touching\
it at all cost!"))
...
smlua_text_utils_dialog_replace(DIALOG_092,1,5,30,200, ("You take all my coins!\
Defeat all my troops,\
and then come here to\
bother me! You wont\
last long Mario, goodbye."))
...
smlua_text_utils_dialog_replace(DIALOG_102,1,5,30,200, ("Woah! It seems like this\
was a magical door!\
Wherever you are,\
it doesnt look good at\
all. You should try to\
find a way out fast!"))

smlua_text_utils_dialog_replace(DIALOG_103,1,4,95,200, ("YOU! You stole all of \
Bowser coins! You will\
pay! Take this!"))
...
smlua_text_utils_dialog_replace(DIALOG_114,1,5,95,200, ("Where are my coins?\
When did I say you\
could take them?\
You will pay for what\
you stole!"))

smlua_text_utils_dialog_replace(DIALOG_115,1,5,95,200, ("Hey! Stop that please!\
Here take this, just\
don't hurt me anymore!"))

smlua_text_utils_dialog_replace(DIALOG_116,1,5,95,200, ("Stop with this! Here\
take this, just stop\
trowing me around!"))

smlua_text_utils_dialog_replace(DIALOG_117,1,1,95,200, ("Who...take...coins?\
Who...climb...me?\
Wake..ancient..ones?\
We no like light...\
Rrrrummbbble...\
...
smlua_text_utils_dialog_replace(DIALOG_120,1,4,30,200, ("Urg...I'll get the stars\
and coins again and\
take over the mushroom\
kingdom...This is not my\
last goodbye!"))
...
smlua_text_utils_dialog_replace(DIALOG_125,1,3,30,200, ("Wow! Is it just me\
or is this bigger from\
the inside?\
I wonder who made\
such a weird place\
like this...anyway,\
...
smlua_text_utils_dialog_replace(DIALOG_159,1,6,30,200, ("These spikes might look\
scary but they're \
actually really helpful! \
Try jumping into one \
